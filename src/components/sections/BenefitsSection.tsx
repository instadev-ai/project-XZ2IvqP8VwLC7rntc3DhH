      ...
      <div className="container">
        <div className="flex flex-col items-center">
          ...
          <div className="mb-16 max-w-3xl mx-auto">
            <img 
              src="https://ellprnxjjzatijdxcogk.supabase.co/storage/v1/object/public/superdev-project-images/66765c88-9ffe-433e-b88a-37d269532bc8/XZ2IvqP8VwLC7rntc3DhH/1741192572624-pasted-image-1741192562709.png" 
              alt="Integration Hub" 
